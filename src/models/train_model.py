...
class WideDeepModel:
    ...
    def train_model(self, epochs=10):
        ...
        model_checkpoint = tf.keras.callbacks.ModelCheckpoint("models/best_model.keras", monitor='val_loss', save_best_only=True)
        ...
        self.model.save("models/my_final_model.keras")
